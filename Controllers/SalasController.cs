...
namespace ProyectoGYM.Controllers
{
    public class SalasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Idsala,Dia,HoraInicio,HoraFinal,Cupo")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idsala,Dia,HoraInicio,HoraFinal,Cupo")] Sala sala)
        {
            if (id != sala.Idsala)
            {
                return NotFound();
